...
# with command line options: step1 --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 8 --geometry DB:Extended --era Run2_2016 --filein file:HLT_2016.root --fileout file:RECO_2016.root --python_filename RECO_2016_cfg.py -n 1
import FWCore.ParameterSet.Config as cms
from FWCore.ParameterSet.VarParsing import VarParsing
options = VarParsing ("python")
options.register("inputFile", "file:HLT.root", VarParsing.multiplicity.singleton, VarParsing.varType.string, "")
