...
# with command line options: step5 --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_mc2017_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --filein file:HLT.root --fileout file:RECO.root --python_filename RECO_2017_cfg.py -n 1 --no_exec
