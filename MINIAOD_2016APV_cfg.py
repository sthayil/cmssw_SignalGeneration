...
# with command line options: step1 --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v8 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2016_HIPM --filein file:RECO_2016APV.root --fileout file:MINI_2016APV.root --python_filename MINI_2016APV_cfg.py -n 1
